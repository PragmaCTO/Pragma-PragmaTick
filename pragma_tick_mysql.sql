-- PragmaTick Complete Production MySQL Database Dump
-- Compatible with MySQL 5.7+ / 8.0+ / MariaDB 10.3+ / cPanel MySQL
-- Contains all Laravel framework tables (sessions, password_reset_tokens, cache, jobs) & application tables + Super Admin user
